...
export function SpeakingSetup({ onStart }: Props): JSX.Element {
  ...
  function start(): void {
    if (!mode) return;
    const taskNumbers =
      mode === "learning" && taskChoice !== "all" ? [taskChoice] : undefined;
  ...
  return (
    <div className="mx-auto max-w-2xl animate-fade-in-up px-6 py-10 sm:py-14">
      ...
      <p className="mt-2 text-slate-500">
        Three spoken tasks, recorded in your browser, transcribed and scored out
        of 20 by the local Whisper + Claude CLIs.
      </p>
