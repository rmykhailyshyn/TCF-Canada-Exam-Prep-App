import examConfig from "../../exam.config.json";
...
// spec: docs/specs/server-runtime.md §Behaviour.8 — a STATIC JSON import (not readFileSync) keeps
// this module free of `node:fs` so it stays in the portable core (the future Worker bundle).
