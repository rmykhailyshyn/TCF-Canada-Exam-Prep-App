...
test.describe('Setup screen', () => {
  ...
  test('offers Listening as a selectable section (no longer "coming soon")', async ({ setupPage }) => {
  ...
  test('real-mode subtitle reflects the listening time limit (35 min)', async ({ page, setupPage }) => {
